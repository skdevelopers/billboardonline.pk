<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @can('profile_access')
                <li class="nav-item">
                    <a href="{{ route("admin.profile.me") }}" class="nav-link {{ request()->is('admin/profile') || request()->is('admin/profile/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-tags nav-icon">
                        </i>
                        Profile
                    </a>
            ...
            @can('road_access')
                <li class="nav-item">
                    <a href="{{ route("admin.roads.index") }}" class="nav-link {{ request()->is('admin/roads') || request()->is('admin/roads/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-tags nav-icon">
            ...
            @can('size_access')
                <li class="nav-item">
                    <a href="{{ route("admin.sizes.index") }}" class="nav-link {{ request()->is('admin/size') || request()->is('admin/size/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-tags nav-icon">
