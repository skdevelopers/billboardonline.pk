...
@if($shop->latitude && $shop->longitude)
    ...
    <script defer>
        function initialize() {
            ...
            const latLng = new google.maps.LatLng({{ $shop->latitude }}, {{ $shop->longitude }});
            const mapOptions = {
                zoom: 12,
                minZoom: 6,
                maxZoom: 17,
            ...
            const image = new google.maps.MarkerImage("{{ asset('assets/images/pin.png') }}", null, null, null, new google.maps.Size(40, 52));
                                        ...
                                        <li>
                                            <div class="geodir-post-title">
                                                <h4 class="geodir-entry-title">
                                                    <a href="{{ route('location', $shop->name) }}" title="View: {{ $shop->name }}">{{ $shop->name }}</a>
                                                </h4>
                                            </div>
                                            <a href="{{ route('location', $shop->name) }}"><img src="{{ $shop->thumbnail }}" alt="{{ $shop->name }}" class="align size-medium_large" width="1400" height="930"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
