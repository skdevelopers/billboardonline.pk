    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.posts.update", [$post->slug]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required" for="meta_keywords"> {{ trans('cruds.post.fields.keywords') }}</label>
                    <input class="form-control {{ $errors->has('meta_keywords') ? 'is-invalid' : '' }}" type="text" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords', $post->meta_keywords) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="ckeditor form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="body" id="body">{{ old('body', $post->body) }}</textarea>
