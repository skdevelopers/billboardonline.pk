                        ...
                        <div class="container py-5">
                            <div class="row h-100 align-items-center py-5">
                                <div class="col-lg-6">
                                    ...
                                    <p class="lead text-muted mb-0">about us page </p>
                                    <p class="lead text-muted">Snippet by <a href="https://billboardonline.pk" class="text-muted">
                                            <u>BillboardOnline Pakistan</u></a>
                                    </p>
                                </div>
